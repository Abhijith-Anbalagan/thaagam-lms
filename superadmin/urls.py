...
urlpatterns = [
    ...
    path('courses/<int:course_id>/edit/',             views.api_course_edit,  name='superadmin_course_edit'),
    ...
    path('concepts/reorder/',                         views.concept_reorder,    name='superadmin_concept_reorder'),
    path('concepts/<int:concept_id>/video/add/',     views.video_add,          name='superadmin_video_add'),
    path('concepts/<int:concept_id>/video/reorder/',  views.video_reorder,      name='superadmin_video_reorder'),
    path('videos/<int:video_id>/delete/',            views.video_delete,   name='superadmin_video_delete'),
    path('videos/<int:video_id>/edit/',              views.video_edit,     name='superadmin_video_edit'),
    path('videos/<int:video_id>/set-duration/',      views.video_set_duration, name='superadmin_video_set_duration'),
